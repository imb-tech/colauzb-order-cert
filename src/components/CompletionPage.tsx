...
const CompletionPage = ({ driverData, onStartNew }: CompletionPageProps) => {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            Xavfsizlik instruktaji muvaffaqiyatli yakunlandi
          </p>
        </div>
        ...
        <Card className="shadow-lg border-safety-green/20 mb-8">
          <div ref={divRef}>
            <CardHeader className="bg-gradient-to-r from-safety-green/10 to-industrial-blue/10">
              <CardTitle className="text-center text-xl">
                Xavfsizlik Instruktaji Sertifikati
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-6 pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Haydovchi</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Transport vositasi</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Instruktaj sanasi</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Sertifikat raqami</p>
              ...
              <div className="text-center p-4 bg-safety-green/10 rounded-lg border border-safety-green/20">
                <div className="flex items-center flex-col justify-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-safety-green">Zavod hududiga kirish ruxsat etildi</span>
                </div>
                <p className="text-sm text-muted-foreground">
                  Barcha xavfsizlik qoidalari o'rganildi va elektron imzo qo'yildi
                </p>
              </div>
            </CardContent>
          </div>
          <CardContent className="space-y-6">
            ...
            <div className="p-4 bg-safety-orange/10 rounded-lg border border-safety-orange/20">
              <h4 className="font-semibold text-safety-orange mb-2">Eslatma:</h4>
        ...
        <div className="text-center mt-8 text-sm text-muted-foreground">
          <p>Zavod Xavfsizlik Bo'limi | {new Date().getFullYear()}</p>
        </div>
      </div>
    </div>
  );
